            ...
            <div class="container">
                ...
                <div class="heading-wrapper">
                    ...
                    <div class="date-box">
                        <h3>今日の曜日</h3>
                        <p>
                            <span class="text-warning">${day_of_week}</span>
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <table class="table table-bordered md-timetable">
                        <tr>
                            ...
                            <td class="${subject_array[1][0].color}"><a
                                href="<c:url value='/registeredSubjects/show?id=${subject_array[1][0].id}'/>">
                        ...
                        <tr>
                            ...
                            <td class="${subject_array[2][0].color}"><a
                                href="<c:url value='/registeredSubjects/show?id=${subject_array[2][0].id}'/>">
                        ...
                        <tr>
                            ...
                            <td class="${subject_array[3][0].color}"><a
                                href="<c:url value='/registeredSubjects/show?id=${subject_array[3][0].id}'/>">
                        ...
                        <tr>
                            ...
                            <td class="${subject_array[4][0].color}"><a
                                href="<c:url value='/registeredSubjects/show?id=${subject_array[4][0].id}'/>">
                        ...
                        <tr>
                            ...
                            <td class="${subject_array[5][0].color}"><a
                                href="<c:url value='/registeredSubjects/show?id=${subject_array[5][0].id}'/>">
                        ...
                        <tr>
                            ...
                            <td class="${subject_array[6][0].color}"><a
                                href="<c:url value='/registeredSubjects/show?id=${subject_array[6][0].id}'/>">
                        ...
                        <tr>
                            ...
                            <td class="${subject_array[7][0].color}"><a
                                href="<c:url value='/registeredSubjects/show?id=${subject_array[7][0].id}'/>">
                        ...
                        <tr>
                            ...
                            <td class="${subject_array[8][0].color}"><a
                                href="<c:url value='registeredSubjects/show?id=${subject_array[8][0].id}'/>">
                    ...
                    <table class="table table-bordered md-timetable">
                        <tr>
                            ...
                            <td class="${subject_array[1][1].color}"><a
                                href="<c:url value='/registeredSubjects/show?id=${subject_array[1][1].id}'/>">
                        ...
                        <tr>
                            ...
                            <td class="${subject_array[2][1].color}"><a
                                href="<c:url value='/registeredSubjects/show?id=${subject_array[2][1].id}'/>">
                        ...
                        <tr>
                            ...
                            <td class="${subject_array[3][1].color}"><a
                                href="<c:url value='/registeredSubjects/show?id=${subject_array[3][1].id}'/>">
                        ...
                        <tr>
                            ...
                            <td class="${subject_array[4][1].color}"><a
                                href="<c:url value='/registeredSubjects/show?id=${subject_array[4][1].id}'/>">
                        ...
                        <tr>
                            ...
                            <td class="${subject_array[5][1].color}"><a
                                href="<c:url value='/registeredSubjects/show?id=${subject_array[5][1].id}'/>">
                        ...
                        <tr>
                            ...
                            <td class="${subject_array[6][1].color}"><a
                                href="<c:url value='/registeredSubjects/show?id=${subject_array[6][1].id}'/>">
                        ...
                        <tr>
                            ...
                            <td class="${subject_array[7][1].color}"><a
                                href="<c:url value='/registeredSubjects/show?id=${subject_array[7][1].id}'/>">
                        ...
                        <tr>
                            ...
                            <td class="${subject_array[8][1].color}"><a
                                href="<c:url value='registeredSubjects/show?id=${subject_array[8][1].id}'/>">
                    ...
                    <table class="table table-bordered md-timetable">
                        <tr>
                            ...
                            <td class="${subject_array[1][2].color}"><a
                                href="<c:url value='/registeredSubjects/show?id=${subject_array[1][2].id}'/>">
                        ...
                        <tr>
                            ...
                            <td class="${subject_array[2][2].color}"><a
                                href="<c:url value='/registeredSubjects/show?id=${subject_array[2][2].id}'/>">
                        ...
                        <tr>
                            ...
                            <td class="${subject_array[3][2].color}"><a
                                href="<c:url value='/registeredSubjects/show?id=${subject_array[3][2].id}'/>">
                        ...
                        <tr>
                            ...
                            <td class="${subject_array[4][2].color}"><a
                                href="<c:url value='/registeredSubjects/show?id=${subject_array[4][2].id}'/>">
                        ...
                        <tr>
                            ...
                            <td class="${subject_array[5][2].color}"><a
                                href="<c:url value='/registeredSubjects/show?id=${subject_array[5][2].id}'/>">
                        ...
                        <tr>
                            ...
                            <td class="${subject_array[6][2].color}"><a
                                href="<c:url value='/registeredSubjects/show?id=${subject_array[6][2].id}'/>">
                        ...
                        <tr>
                            ...
                            <td class="${subject_array[7][2].color}"><a
                                href="<c:url value='/registeredSubjects/show?id=${subject_array[7][2].id}'/>">
                        ...
                        <tr>
                            ...
                            <td class="${subject_array[8][2].color}"><a
                                href="<c:url value='registeredSubjects/show?id=${subject_array[8][2].id}'/>">
                    ...
                    <table class="table table-bordered md-timetable">
                        <tr>
                            ...
                            <td class="${subject_array[1][3].color}"><a
                                href="<c:url value='/registeredSubjects/show?id=${subject_array[1][3].id}'/>">
                        ...
                        <tr>
                            ...
                            <td class="${subject_array[2][3].color}"><a
                                href="<c:url value='/registeredSubjects/show?id=${subject_array[2][3].id}'/>">
                        ...
                        <tr>
                            ...
                            <td class="${subject_array[3][3].color}"><a
                                href="<c:url value='/registeredSubjects/show?id=${subject_array[3][3].id}'/>">
                        ...
                        <tr>
                            ...
                            <td class="${subject_array[4][3].color}"><a
                                href="<c:url value='/registeredSubjects/show?id=${subject_array[4][3].id}'/>">
                        ...
                        <tr>
                            ...
                            <td class="${subject_array[5][3].color}"><a
                                href="<c:url value='/registeredSubjects/show?id=${subject_array[5][3].id}'/>">
                        ...
                        <tr>
                            ...
                            <td class="${subject_array[6][3].color}"><a
                                href="<c:url value='/registeredSubjects/show?id=${subject_array[6][3].id}'/>">
                        ...
                        <tr>
                            ...
                            <td class="${subject_array[7][3].color}"><a
                                href="<c:url value='/registeredSubjects/show?id=${subject_array[7][3].id}'/>">
                        ...
                        <tr>
                            ...
                            <td class="${subject_array[8][3].color}"><a
                                href="<c:url value='registeredSubjects/show?id=${subject_array[8][3].id}'/>">
                    ...
                    <table class="table table-bordered md-timetable">
                        <tr>
                            ...
                            <td class="${subject_array[1][4].color}"><a
                                href="<c:url value='/registeredSubjects/show?id=${subject_array[1][4].id}'/>">
                        ...
                        <tr>
                            ...
                            <td class="${subject_array[2][4].color}"><a
                                href="<c:url value='/registeredSubjects/show?id=${subject_array[2][4].id}'/>">
                        ...
                        <tr>
                            ...
                            <td class="${subject_array[3][4].color}"><a
                                href="<c:url value='/registeredSubjects/show?id=${subject_array[3][4].id}'/>">
                        ...
                        <tr>
                            ...
                            <td class="${subject_array[4][4].color}"><a
                                href="<c:url value='/registeredSubjects/show?id=${subject_array[4][4].id}'/>">
                        ...
                        <tr>
                            ...
                            <td class="${subject_array[5][4].color}"><a
                                href="<c:url value='/registeredSubjects/show?id=${subject_array[5][4].id}'/>">
                        ...
                        <tr>
                            ...
                            <td class="${subject_array[6][4].color}"><a
                                href="<c:url value='/registeredSubjects/show?id=${subject_array[6][4].id}'/>">
                        ...
                        <tr>
                            ...
                            <td class="${subject_array[7][4].color}"><a
                                href="<c:url value='/registeredSubjects/show?id=${subject_array[7][4].id}'/>">
                        ...
                        <tr>
                            ...
                            <td class="${subject_array[8][4].color}"><a
                                href="<c:url value='registeredSubjects/show?id=${subject_array[8][4].id}'/>">
                    ...
                    <table class="table table-bordered md-timetable">
                        <tr>
                            ...
                            <td class="${subject_array[1][5].color}"><a
                                href="<c:url value='/registeredSubjects/show?id=${subject_array[1][5].id}'/>">
                        ...
                        <tr>
                            ...
                            <td class="${subject_array[2][5].color}"><a
                                href="<c:url value='/registeredSubjects/show?id=${subject_array[2][5].id}'/>">
                        ...
                        <tr>
                            ...
                            <td class="${subject_array[3][5].color}"><a
                                href="<c:url value='/registeredSubjects/show?id=${subject_array[3][5].id}'/>">
                        ...
                        <tr>
                            ...
                            <td class="${subject_array[4][5].color}"><a
                                href="<c:url value='/registeredSubjects/show?id=${subject_array[4][5].id}'/>">
                        ...
                        <tr>
                            ...
                            <td class="${subject_array[5][5].color}"><a
                                href="<c:url value='/registeredSubjects/show?id=${subject_array[5][5].id}'/>">
                        ...
                        <tr>
                            ...
                            <td class="${subject_array[6][5].color}"><a
                                href="<c:url value='/registeredSubjects/show?id=${subject_array[6][5].id}'/>">
                        ...
                        <tr>
                            ...
                            <td class="${subject_array[7][5].color}"><a
                                href="<c:url value='/registeredSubjects/show?id=${subject_array[7][5].id}'/>">
                        ...
                        <tr>
                            ...
                            <td class="${subject_array[8][5].color}"><a
                                href="<c:url value='registeredSubjects/show?id=${subject_array[8][5].id}'/>">
