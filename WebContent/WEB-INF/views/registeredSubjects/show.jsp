        ...
        <div class="main">
            <div class="container">
                <div class="heading-wrapper">
                    <h2>
                        <i class="fas fa-book"></i>登録済み講義詳細:&nbsp;${subject.name}
                    </h2>
                </div>
                <c:choose>
                    <c:when test="${subject != null}">
                        <div class="show-wrapper">
                            ...
                            <div class="btn-wrapper show-btn-wrapper">
                                ...
                                <form method="POST" action="<c:url value='/registeredSubjects/destroy' />">
                                    <a class="btn btn-info" href="<c:url value='/takeSubjects/index' />">講義一覧に戻る</a>
                                    <input type="hidden" name="_token" value="${_token}">
                                    <button class="btn btn-dark" type="submit">登録を削除する</button>
                                </form>
                            </div>
                        </div>
                        <div class="show-wrapper">
