        ...
        <div class="main">
            <div class="container">
                <div class="heading-wrapper">
                    ...
                    <div class="count-box">
                        <h3>現在の登録生徒数</h3>
                        <p><span class="text-warning">${students_count}</span>人</p>
                    </div>
                </div>
                         ...
                         <tbody>
                            ...
                            <c:forEach var="student" items="${students}">
                                <tr>
                                    ...
                                    <td><a class="btn btn-info" href="<c:url value='/people/show?id=${student.id}&authority=0' />">詳細</a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </tbody>
                    ...
                    <div class="pagenation">
                        <c:forEach var="i" begin="1"
                            ...
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <a href="<c:url value='/people/students/index?page=${i}' />"> <c:out
                                            value="${i}" />&nbsp;
                                    </a>
                                </c:otherwise>
                            </c:choose>
                ...
                <div class="new-btn-wrapper">
                    <a class="btn btn-primary" href="<c:url value='/people/new?authority=0'/>">生徒の登録</a>
                </div>
            </div>
        </div>
